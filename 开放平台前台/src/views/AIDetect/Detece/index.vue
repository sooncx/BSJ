  ...
  <div class="Detect">
    ...
    <div class="imgTypes">
      <div class="imgTypes_top">
        ...
        <br />
        <p>该功能演示是基于只能检测API搭建的，如果您对技术能力有特别要求，请查看下方的产品目录或联系我们</p>
      </div>
      ...
      <div class="detection_bottom">
        ...
        >
          ...
          <div class="cardDetail">
            <h3>{{index == 1?'检测速度快':index == 2?'不限人脸数量':'识别精度高'}}</h3>
          </div>
        </div>
      </div>
    </div>
...
.Detect {
  .headerBox {
    ...
    &_left {
      ...
      .btn2 {
        background: #0856ea;
        border: 1px solid #0856ea !important;
        color: #fff;
      }
    }
    &_right {
