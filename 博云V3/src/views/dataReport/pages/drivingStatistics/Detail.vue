<template>
  <div class="detailTable">
    ...
    <div class="detailTable__footer">
      ...
      <a-button type="primary" @click="onExport" v-permission="150304">
...
export default defineComponent({
  props: {
    row: {
      type: Object as PropType<
        ElementOf<APIType.pageAccReportRes["obj"]["data"]> & {
          accState: number;
        }
      >,
      default: null,
  ...
  setup(props) {
    ...
    const tableData = ref(<APIType.pageAccDetailRes["obj"]["data"]>[]);
    ...
    const getData = async () => {
      ...
      const info = {
        ...
        accBeginTime: props.row.beginTime,
        accEndTime: props.row.endTime,
        accState: props.row.accState,
        pageNumber: pagination.current,
        pageSize: pagination.pageSize,
      };
      const { flag, obj, msg } = await API.pageAccDetail(info);
